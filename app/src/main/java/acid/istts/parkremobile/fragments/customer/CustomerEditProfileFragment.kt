 ...
 * Use the [CustomerEditProfileFragment.newInstance] factory method to
...
class CustomerEditProfileFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CustomerEditProfileFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CustomerEditProfileFragment().apply {
