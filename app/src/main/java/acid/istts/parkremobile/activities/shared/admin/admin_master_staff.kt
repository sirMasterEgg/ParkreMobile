...
import acid.istts.parkremobile.databinding.ActivityAdminMasterStaffBinding
...
class admin_master_staff : AppCompatActivity() {
    lateinit var drawerLayout: DrawerLayout
    lateinit var navigationView: NavigationView
    lateinit var toolbar: Toolbar
    lateinit var binding : ActivityAdminMasterStaffBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_admin_master_staff)
        ...
        binding = ActivityAdminMasterStaffBinding.inflate(layoutInflater)
